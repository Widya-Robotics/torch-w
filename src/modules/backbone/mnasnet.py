...
class MNASNet(Module):
    ...
    def __init__(
        ...
        if self.include_head is not None:
            assert isinstance(self.include_head, int) , 'include wether should be empty or integer'
...
def mnasnet0_5(**kwargs: Any) -> MNASNet:
...
def mnasnet0_75(**kwargs: Any) -> MNASNet:
...
def mnasnet1_0(**kwargs: Any) -> MNASNet:
...
def mnasnet1_3(**kwargs: Any) -> MNASNet:
